...
class Login {
    ...
    loginMojang() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            infoLogin.innerHTML = "Conectando con los servidores...";
            ...
            if(account_connect == null || account_connect.error) {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'El correo que has introducido no es valido'
                return
            }
    ...
    loginOffline() {
        let mailInput = document.querySelector('.Nombre')
        let passwordInput = document.querySelector('.Password')
        let cancelMojangBtn = document.querySelector('.cancel-mojang')
        let infoLogin = document.querySelector('.info-login')
        let loginBtn = document.querySelector(".login-btn")
        ...
        let desaparecer1 = document.querySelector('.desaparecer1')
        let resetpassword = document.querySelector('.password-reset')
        ...
        loginBtn.addEventListener("click", () => {
            ...
            if (mailInput.value == "deivitYT") {
                infoLogin.innerHTML = "No puedes entrar con esta cuenta :/"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            let account_connect = new minecraftAuth.CrackedAccount(mailInput.value);

        
            account_connect.getProfile();


            let account = {
                access_token: account_connect.accessToken,
                uuid: account_connect.uuid,
                name: account_connect.username,
                user_properties: account_connect.profile,
                meta: {
                    type: "Crack"
                }
            }
